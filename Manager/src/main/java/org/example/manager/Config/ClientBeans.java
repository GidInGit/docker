...
public class ClientBeans {
    ...
    public UsersRestClient productsRestClient(
            @Value("${users.service.list.uri:users.service.list.uri.reserve}") String catalogueBaseUri,
        ...
        return new UsersRestClientRestClient(
                RestClient.builder()
                        ...
                        .requestInterceptor(new BasicAuthenticationInterceptor(username, password)).build());
    }
}
